      ...
      (data) => {
        ...
        if (data.data != null) {
          ...
          this.achievementForm.patchValue({
            achievement: this.commonProfileDraft.achievements != null ? this.commonProfileDraft.achievements.achievements : null
          });

          this.achievementForm.patchValue({
            idAchievement: this.commonProfileDraft.achievements != null ? this.commonProfileDraft.achievements.idAchievement : null
          });
