...
export class ResearchComponent implements OnInit {
    ...
    researchForTempListTable() {
        ...
        if (this.researchAreaForm.valid) {
            ...
            const selectedIdResearchArea = this.researchAreaForm.get('idResearchArea')?.value;
            const selectedResearchArea = selectedIdResearchArea != '-1' ? this.researchAreas.find(
                (researchArea: ResearchArea) => researchArea.id == selectedIdResearchArea) : null;
            ...
            const research: Research = {
                ...
                researchArea: selectedResearchArea != null ? selectedResearchArea.name : null,
                ...
                if (data.data != null) {
                    ...
                    this.commonProfileDraft.researches.forEach((research: Research) => {
                        ...
                        const selectedResearchArea = this.researchAreas.find(
                            (researchArea: ResearchArea) => researchArea.id == research.idResearchArea);
